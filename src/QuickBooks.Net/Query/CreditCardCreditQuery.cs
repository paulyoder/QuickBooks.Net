...
namespace QuickBooks.Net.Query
{
    public class CreditCardCreditQuery :
        CommonTransactionQueriesWithRefNumber<ICreditCardCreditQuery, CreditCardCredit>,
        ICreditCardCreditQuery
    {
        public CreditCardCreditQuery(IQBSessionInternal session)
            : base(session, "CreditCardCreditQueryRq", "CreditCardCreditQueryRs")
        {
            _returnQuery = this;
        }
